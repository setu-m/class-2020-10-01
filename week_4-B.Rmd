...
classes <- bind_rows(list(d_2019, d_2018, d_2017, d_2016, d_2015), .id = "year") %>%
...
```{r}
big_classes <- function(x = classes, my_year = 2015){
  stopifnot(is.numeric(my_year))
...
tibble(q_enrollment = mutate(map(quantile)))
